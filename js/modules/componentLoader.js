            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ${comparables.map((comp, index) => {
                  ...
                  // Try multiple image property variations and log what we find
                  const imageUrl = comp.image_url || comp.imageUrl || comp.image || comp.thumbnail || 
                                  comp.picture_url || comp.photo_url || comp.photo || comp.images?.[0] || '';
                  ...
                  <a href="${comp.url || comp.airbnb_url || comp.airbnbUrl || '#'}" target="_blank" 
                    ...
                    <img src="${imageUrl || 'https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=300&h=200&fit=crop'}" 
                         alt="${comp.title || 'Comparable Property'}" class="w-full h-48 object-cover"
                         onerror="this.src='https://images.unsplash.com/photo-1568605114967-8130f3a36994?w=300&h=200&fit=crop'"
                         onload="console.log('Image loaded for:', '${comp.title || 'Comparable'}')"
