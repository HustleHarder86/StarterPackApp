            ...
            <div class="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ${comparables.map((comp, index) => {
                  ...
                  // Use the same image property as the dashboard: comp.image
                  const imageUrl = comp.image || comp.image_url || comp.imageUrl || comp.thumbnail || 
                  ...
                  // Only show images if we have actual image URLs, otherwise hide the image element
